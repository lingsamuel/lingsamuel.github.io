...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("ebnf",(()=>{"use strict";return e=>{
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
},...B,...k,...S,I,K,...z,...q,U,G]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
})).join("")}return n=>{
const a="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",i={
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
illegal:"[^\\s\\}]"}}})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
...
starts:{end:/$/,contains:[i,c,r,t,l,a]}}]}}})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{var n={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
